...
class VirtualClassroom extends StatelessWidget {
  const VirtualClassroom({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
        ...
        color: whiteBg1,
        child: Center(child: Text("Virtual Classroom", style: TextStyle(color: black1, fontWeight: FontWeight.w400, fontFamily: "Poppins", fontSize: 50),)),
      )
    );
