...
class AtharvaPayment extends StatelessWidget {
  const AtharvaPayment({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: Container(
          ...
          color: whiteBg1,
          child: Center(child: Text("Atharva Payment", style: TextStyle(color: black1, fontWeight: FontWeight.w400, fontFamily: "Poppins", fontSize: 50),)),
        )
    );
